...
@RestController
@RequestMapping(value = "/v1/othercake", produces = MediaType.APPLICATION_JSON_VALUE)
@Tag(name = OtherCakeController.TAG, description = "API with documentation annotations")
public class OtherCakeController
{
	static final String TAG = "other";
	private final CakeService service;
	
	public OtherCakeController(CakeService service)
	{
